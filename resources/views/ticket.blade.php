...
<body style="background-color: #f7f8fc;">
    ...
    <section style="display: grid; place-items: center; min-height: 100vh;">
        <div style="max-height: 96vh; width: 1000px; background-color: #cbd5e0; box-shadow: 0px 4px 20px rgba(0, 0, 0, 0.1); display: flex;">
            <div style="background-color: #6b7280; position: relative; width: 75%;">
